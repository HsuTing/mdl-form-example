...
/***/ function(module, exports, __webpack_require__) {
	...
	var _mdlForm = __webpack_require__(159);

	var _mdlForm2 = _interopRequireDefault(_mdlForm);

	var _mdlFormInput = __webpack_require__(169);

	var _mdlFormInput2 = _interopRequireDefault(_mdlFormInput);

	var _mdlFormRadio = __webpack_require__(170);

	var _mdlFormRadio2 = _interopRequireDefault(_mdlFormRadio);

	var _mdlFormTextarea = __webpack_require__(171);

	var _mdlFormTextarea2 = _interopRequireDefault(_mdlFormTextarea);

	var _mdlFormFile = __webpack_require__(172);

	var _mdlFormFile2 = _interopRequireDefault(_mdlFormFile);
	...
	var _style5 = __webpack_require__(177);
	...
	(function () {
	  var Tags = { file: _mdlFormFile2.default, textarea: _mdlFormTextarea2.default, radio: _mdlFormRadio2.default, default: _mdlFormInput2.default };
	  var Data = {
	    'title': {
	      'label': 'Form Title'
	    },
	  ...
	  _reactDom2.default.render(_react2.default.createElement(_mdlForm2.default, {
	    data: Data,
	    tags: Tags
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _show = __webpack_require__(161);

	var _show2 = _interopRequireDefault(_show);

	var _hide = __webpack_require__(165);
	...
	var _submit2 = __webpack_require__(168);
	...
	var form = function (_React$Component) {
	  ...
	  _createClass(form, [{
	    ...
	    value: function componentDidMount() {
	      var self = this;
	      (0, _jquery2.default)(this.refs.form).off("animationend webkitAnimationEnd oAnimationEnd MSAnimationEnd").on("animationend webkitAnimationEnd oAnimationEnd MSAnimationEnd", function (e) {
	        if ((0, _jquery2.default)(this).hasClass('form-hide-animation')) {
	          (0, _jquery2.default)(this).removeClass('form-hide-animation').addClass('form-hide');

	          self.setState({ 'data': self.props.data });
	        } else if ((0, _jquery2.default)(this).hasClass('form-show-animation')) {
	          (0, _jquery2.default)(this).removeClass('form-show-animation').addClass('form-show');
	        }
	      });
	    ...
	    value: function componentWillReceiveProps(nextProps) {
	      if (this.props.noAnimation != true) {
	        (0, _jquery2.default)(this.refs.form).removeClass('form-show').addClass('form-hide-animation');
	      }
	    }
	  }, {
	    ...
	    value: function componentDidUpdate(prevProps, prevState) {
	      ...
	      if (this.props.noAnimation != true) {
	        (0, _jquery2.default)(this.refs.form).removeClass('form-hide').addClass('form-show-animation');
	      }
	      componentHandler.upgradeDom();
	    }
	  }, {
	    ...
	    value: function render() {
	      ...
	      var form = this.state.data.form == undefined ? [] : this.state.data.form;
	      var defaultTag = tags["default"] == undefined ? tags[Object.keys(tags)[0]] : tags["default"];

	      return _react2.default.createElement(
	        'div',
	        { ref: 'form' },
	        _react2.default.createElement(_title2.default, { data: this.state.data.title }),
	        _react2.default.createElement(
	          'div',
	          { className: 'form-body' },
	          form.map(function (d, i) {
	            var Component = d.tag == undefined ? defaultTag : tags[d.tag];

	            if (d.id == undefined) {
	              d.id = 'input' + i;
	              var text = "If you need to use some elements in 'Form', you need to give it a 'id'. Error at item " + (i * 1 + 1) + ".";
	              console.error(text);
	            }
	            ...
	            return _react2.default.createElement(
	              ...
	              _react2.default.createElement(Component, {
	                data: d,
	                keyDown: _this2._keyDown.bind(_this2),
	                getData: _this2._getData.bind(_this2),
	                getComponents: _this2._getComponents.bind(_this2)
	              })
	            );
	          }, this)
	        ),
	        _react2.default.createElement(_submit3.default, { data: this.state.data.submit, submit: this._submit.bind(this) })
	      );
	    }
	  }, {
	    key: '_keyDown',
	    ...
	    key: '_getData',
	    value: function _getData(id, data, e) {
	      this.state.output[id] = data;
	    }
	  }, {
	    key: '_getComponents',
	    value: function _getComponents(id, component, e) {
	    ...
	    value: function _submit(e) {
	      ...
	      (0, _jquery2.default)(this.state.data.form).each(function (i, d) {
	        if (!d.isNotRequire) {
	          if (output[d.id] == undefined || output[d.id] == '') {
	            (0, _jquery2.default)(components[d.id].refs.component).addClass('is-invalid');
	            checkInvalid = true;
	          }
	        }
	      });
	      ...
	      var submit = this.props.data.submit;
	      _jquery2.default.post(submit.url, output, function (data, status) {
	        var success = submit.success;
	        if (success != undefined) {
	          success(data, status);
	        }
	      }).fail(function () {
	        var fail = submit.fail;
	        if (fail != undefined) {
	          fail(output);
	        }
	      });
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		if(!content.locals) {
			module.hot.accept("!!./../../../css-loader/index.js!./show.css", function() {
				var newContent = require("!!./../../../css-loader/index.js!./show.css");
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "@keyframes animation-form-show {\n  from { left: -100%; opacity: 0; }\n  to { left: 0px; opacity: 1; }\n}\n\n.form-show-animation {\n  position: relative;\n  overflow: hidden;\n  animation: animation-form-show 0.5s cubic-bezier(0.65, 0.01, 0.36, 1);\n}\n\n.form-show {\n  display: block;\n}\n", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../../css-loader/index.js!./hide.css", function() {
				var newContent = require("!!./../../../css-loader/index.js!./hide.css");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "@keyframes animation-form-hide {\n  from { left: 0px; opacity: 1; }\n  to { left: -100%; opacity: 0; }\n}\n\n.form-hide-animation {\n  position: relative;\n  overflow: hidden;\n  animation: animation-form-hide 0.5s cubic-bezier(0.65, 0.01, 0.36, 1);\n}\n\n.form-hide {\n  display: block;\n}\n", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var input = function (_React$Component) {
	  ...
	  _createClass(input, [{
	    ...
	    value: function render() {
	      var data = this.props.data;
	      var defaultValue = data.default != undefined ? data.default : '';
	      var type = data.type != undefined ? data.type : 'text';
	      this.props.getData(data.id, defaultValue);
	      this.props.getComponents(data.id, this);

	      return _react2.default.createElement(
	        'div',
	        { ref: 'component', className: 'mdl-textfield mdl-js-textfield mdl-textfield--floating-label', style: data.style },
	        ...
	        _react2.default.createElement(
	          'label',
	          { className: 'mdl-textfield__label', htmlFor: data.id },
	          data.label
	        ),
	        _react2.default.createElement(
	          'span',
	    ...
	    value: function _onChange(e) {
	      ...
	      if (!(0, _jquery2.default)(this.refs.component).hasClass('is-dirty') || (0, _jquery2.default)(this.refs.component).hasClass('is-invalid')) {
	        (0, _jquery2.default)(this.refs.component).addClass('is-invalid');
	  ...
	  _createClass(radio, [{
	    ...
	    value: function render() {
	      ...
	      if (data == undefined) {
	        ...
	        return _react2.default.createElement(
	          'div',
	          { ref: 'component', id: data.id, style: data.style },
	          data.item.map(function (d, i) {
	            return _react2.default.createElement(
	              'label',
	              { key: i, className: 'mdl-radio mdl-js-radio mdl-js-ripple-effect', htmlFor: data.id + "-" + i, style: d.style },
	              _react2.default.createElement('input', { type: 'radio',
	                id: data.id + "-" + i,
	                className: 'mdl-radio__button',
	                name: data.id,
	                value: d.value,
	                onClick: _this2._click.bind(_this2),
	    ...
	    value: function _click(e) {
	      var data = this.props.data;
	      (0, _jquery2.default)(this.refs.component).removeClass('is-invalid');

	      var val = (0, _jquery2.default)(this.refs.component).find('input[type="radio"]:checked').val();
	      if (data.change != undefined) {
	        var temp = data.change(val);
	        if (temp != undefined) {
	          val = temp;
	...
	var textarea = function (_React$Component) {
	  ...
	  _createClass(textarea, [{
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        'div',
	        { ref: 'component', className: 'mdl-textfield mdl-js-textfield', style: data.style },
	        _react2.default.createElement('textarea', { className: 'mdl-textfield__input', type: 'text', rows: data.rows, id: data.id, onChange: this._onChange.bind(this) }),
	        _react2.default.createElement(
	          'label',
	          { className: 'mdl-textfield__label', htmlFor: data.id },
	          data.label
	...
	var file = function (_React$Component) {
	  ...
	  _createClass(file, [{
	    ...
	    value: function render() {
	      ...
	      var Input = undefined;
	      if (data.isMultiple) {
	        Input = _react2.default.createElement('input', { id: data.id, type: 'file', style: { display: 'none' }, onChange: this._onChange.bind(this), multiple: true });
	      } else {
	        Input = _react2.default.createElement('input', { id: data.id, type: 'file', style: { display: 'none' }, onChange: this._onChange.bind(this) });
	      }

	      return _react2.default.createElement(
	        'div',
	        { ref: 'component', className: 'file mdl-card mdl-shadow--2dp', style: data.style },
	        _react2.default.createElement(
	          'div',
	          { className: 'mdl-card__supporting-text', style: {
	              height: "100%"
	            } },
	          _react2.default.createElement(
	            'label',
	    ...
	    value: function _getData(files) {
	      ...
	      var _loop = function _loop(i) {
	        ...
	        reader.onload = function (theFile) {
	          return function (e) {
	            ...
	            output.push(info);
	            if (files.length == 1) {
	              (0, _jquery2.default)(_this2.refs.component).find('.files').html(file.name);
	            } else if (file.length != 0) {
	              (0, _jquery2.default)(_this2.refs.component).find('.files').html("已上傳" + files.length + "個檔案");
	            }
	          };
	        }(file);
	      };
	      ...
	      if (files.length == 0) {
	        (0, _jquery2.default)(this.refs.component).addClass('is-invalid');
	        (0, _jquery2.default)(this.refs.component).find('.files').html(data.label);
	        this.props.getData(data.id, '');
	      } else {
	        (0, _jquery2.default)(this.refs.component).removeClass('is-invalid');
	        this.props.getData(data.id, output);
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".is-invalid .mdl-radio__outer-circle,\n.is-invalid .mdl-radio.is-checked .mdl-radio__outer-circle {\n  border-color: #de3226;\n}\n\n.is-invalid .mdl-radio__inner-circle,\n.is-invalid .mdl-radio__ripple-container .mdl-ripple {\n  background-color: #de3226;\n}\n\n.is-invalid .mdl-radio__label {\n  color: #de3226;\n}\n", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".is-invalid .mdl-textfield__input { \n  border-color: #de3226;\n}\n", ""]);
